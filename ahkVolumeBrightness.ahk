; Alt + PgUp/PgDn -> VolumeUp/Down 
; Alt + Delete    -> Mute/Unmute volume
; Alt + Home/End  -> BrightUp/Down
...
!Home::BS.SetBrightness(10)
!End::BS.SetBrightness(-10)

!PgUp::SoundSet, +2
!PgDn::SoundSet, -2
!Delete::SoundSet, +1,,Mute
